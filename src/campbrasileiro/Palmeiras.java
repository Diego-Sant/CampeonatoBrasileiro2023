...
public class Palmeiras extends JFrame implements ActionListener {
	...
	Palmeiras() {
		...
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/palmeiras.png"));
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Palmeiras", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Palmeiras'";
			Conn c = new Conn();
