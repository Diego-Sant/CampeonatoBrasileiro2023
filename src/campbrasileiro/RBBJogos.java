...
public class RBBJogos extends JFrame implements ActionListener {
	...
	RBBJogos() {
		...
		try {
			String query = "SELECT * FROM jogos WHERE time= 'Red Bull Bragantino'";
			Conn c = new Conn();
