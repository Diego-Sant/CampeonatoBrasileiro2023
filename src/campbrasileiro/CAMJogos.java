...
public class CAMJogos extends JFrame implements ActionListener {
	...
	CAMJogos() {
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Atlético Mineiro", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogos WHERE time= 'Atlético Mineiro'";
			Conn c = new Conn();
