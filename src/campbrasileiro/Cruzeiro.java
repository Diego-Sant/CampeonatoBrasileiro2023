...
public class Cruzeiro extends JFrame implements ActionListener {
	...
	Cruzeiro() {
		...
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/cruzeiro.png"));
		...
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Cruzeiro'";
			Conn c = new Conn();
