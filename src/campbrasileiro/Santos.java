...
public class Santos extends JFrame implements ActionListener {
	...
	Santos() {
		...
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/santos.png"));
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Santos", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Santos'";
			Conn c = new Conn();
