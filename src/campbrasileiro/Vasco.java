...
public class Vasco extends JFrame implements ActionListener {
	...
	Vasco() {
		...
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/vasco.png"));
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Vasco", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Vasco'";
			Conn c = new Conn();
