...
public class AthleticoParanaense extends JFrame implements ActionListener {
	...
	AthleticoParanaense() {
		super("Athletico Paranaense");
		
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/athleticopr.png"));
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Athletico Paranaense", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Athletico Paranaense'";
			Conn c = new Conn();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AthleticoParanaense frame = new AthleticoParanaense();
