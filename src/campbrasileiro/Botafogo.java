...
public class Botafogo extends JFrame implements ActionListener {
	...
	Botafogo() {
		...
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/botafogo.png"));
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Botafogo", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Botafogo'";
			Conn c = new Conn();
