...
public class Flamengo extends JFrame implements ActionListener {
	...
	Flamengo() {
		...
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/flamengo.png"));
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Flamengo", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Flamengo'";
			Conn c = new Conn();
