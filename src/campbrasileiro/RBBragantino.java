...
public class RBBragantino extends JFrame implements ActionListener {
	...
	RBBragantino() {
		super("Red Bull Bragantino");
		
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/bragantino.png"));
		Image img2 = img1.getImage().getScaledInstance(230, 180, Image.SCALE_DEFAULT);
		ImageIcon img3 = new ImageIcon(img2);
		JLabel l7 = new JLabel(img3);
		l7.setBounds(500, 50, 230, 180);
		add(l7);
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Red Bull Bragantino", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Red Bull Bragantino'";
			Conn c = new Conn();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RBBragantino frame = new RBBragantino();
