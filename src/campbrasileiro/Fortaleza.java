...
public class Fortaleza extends JFrame implements ActionListener {
	...
	Fortaleza() {
		...
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/fortaleza.png"));
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Fortaleza", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Fortaleza'";
			Conn c = new Conn();
