...
public class Bahia extends JFrame implements ActionListener {
	...
	Bahia() {
		...
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/bahia.png"));
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Bahia", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Bahia'";
			Conn c = new Conn();
