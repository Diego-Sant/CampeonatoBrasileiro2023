...
public class Corinthians extends JFrame implements ActionListener {
	...
	Corinthians() {
		...
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/corinthians.png"));
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Corinthians", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Corinthians'";
			Conn c = new Conn();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Corinthians frame = new Corinthians();
