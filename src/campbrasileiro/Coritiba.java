...
public class Coritiba extends JFrame implements ActionListener {
	...
	Coritiba() {
		...
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/coritiba.png"));
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Coritiba", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Coritiba'";
			Conn c = new Conn();
