...
public class Goias extends JFrame implements ActionListener {
	...
	Goias() {
		...
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/goias.png"));
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Goiás", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Goias'";
			Conn c = new Conn();
