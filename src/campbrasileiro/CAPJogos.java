...
public class CAPJogos extends JFrame implements ActionListener {
	...
	CAPJogos() {
		...
		try {
			String query = "SELECT * FROM jogos WHERE time= 'Athletico Paranaense'";
			Conn c = new Conn();
