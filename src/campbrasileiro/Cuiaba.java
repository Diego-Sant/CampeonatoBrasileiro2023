...
public class Cuiaba extends JFrame implements ActionListener {
	...
	Cuiaba() {
		...
		ImageIcon img1 = new ImageIcon(ClassLoader.getSystemResource("icons/cuiaba.png"));
		...
		jp.setBorder(new TitledBorder(new LineBorder(new Color(98, 0, 238), 2), // ((r: g: b:), thickness)
				"Cuiabá", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(55, 0, 179)));
		add(jp);
		
		try {
			String query = "SELECT * FROM jogador WHERE time= 'Cuiaba'";
			Conn c = new Conn();
