...
import arana from '@/public/jogadores/arana.png'
import felipao from '@/public/jogadores/felipao.png'
import battaglia from '@/public/jogadores/battaglia.png'
import hulk from '@/public/jogadores/hulk.png'
import rubens from '@/public/jogadores/rubens.png'
import zaracho from '@/public/jogadores/zaracho.png'
import jemerson from '@/public/jogadores/jemerson.png'
import dodo from '@/public/jogadores/dodo.png'
import hyoran from '@/public/jogadores/hyoran.png'
import lemos from '@/public/jogadores/lemos.png'
import igorgomes from '@/public/jogadores/igorgomes.png'
import paulinho from '@/public/jogadores/paulinho.png'
import vargas from '@/public/jogadores/vargas.png'
import pavon from '@/public/jogadores/pavon.png'
import pedrinho from '@/public/jogadores/pedrinho.png'
import kardec from '@/public/jogadores/kardec.png'
import otavio from '@/public/jogadores/otavio.png'
import mariano from '@/public/jogadores/mariano.png'
import saravia from '@/public/jogadores/saravia.png'
import edenilson from '@/public/jogadores/edenilson.png'
import patrick from '@/public/jogadores/patrick.png'
import everson from '@/public/jogadores/everson.png'
import fuchs from '@/public/jogadores/fuchs.png'
...
export default function Atletico() {
  const [showBackground, setShowBackground] = useState<ShowBackgroundState>({ felipao: false, arana: false, battaglia: false, hulk: false, rubens: false, jemerson: false, dodo: false, hyoran: false, lemos: false, igorgomes: false, paulinho: false, kardec: false, otavio: false, mariano: false, edenilson: false, everson: false, fuchs: false, patrick: false, vargas: false, pavon: false, pedrinho: false, saravia: false, zaracho: false});
  ...
  return (
    <div>
      <Layout title='Clube Atlético Mineiro'>
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6'>

          <div className={containerClasses} onClick={() => handleClick('felipao')}>
              <PlayerImage src={felipao} alt="felipao" />
              {showBackground.felipao && (
                <>
            ...
            <div className={containerClasses} onClick={() => handleClick('everson')}>
              <PlayerImage src={everson} alt="everson" />
              {showBackground.everson && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
            ...
            <div className={containerClasses} onClick={() => handleClick('arana')}>
              <PlayerImage src={arana} alt="arana" />
              {showBackground.arana && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
            ...
            <div className={containerClasses} onClick={() => handleClick('dodo')}>
              <PlayerImage src={dodo} alt="dodo" />
              {showBackground.dodo && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
            ...
            <div className={containerClasses} onClick={() => handleClick('lemos')}>
              <PlayerImage src={lemos} alt="lemos" />
              {showBackground.lemos && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
            ...
            <div className={containerClasses} onClick={() => handleClick('fuchs')}>
              <PlayerImage src={fuchs} alt="fuchs" />
              {showBackground.fuchs && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
            ...
            <div className={containerClasses} onClick={() => handleClick('jemerson')}>
              <PlayerImage src={jemerson} alt="jemerson" />
              {showBackground.jemerson && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
            ...
            <div className={containerClasses} onClick={() => handleClick('mariano')}>
              <PlayerImage src={mariano} alt="mariano" />
              {showBackground.mariano && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
            ...
            <div className={containerClasses} onClick={() => handleClick('saravia')}>
              <PlayerImage src={saravia} alt="saravia" />
              {showBackground.saravia && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
                      <p className='mr-4'>Jogados: 7</p>
            ...
            <div className={containerClasses} onClick={() => handleClick('otavio')}>
              <PlayerImage src={otavio} alt="otavio" />
              {showBackground.otavio && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
                      <p className='mr-4'>Jogados: 4</p>
            ...
            <div className={containerClasses} onClick={() => handleClick('battaglia')}>
              <PlayerImage src={battaglia} alt="battaglia" />
              {showBackground.battaglia && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
            ...
            <div className={containerClasses} onClick={() => handleClick('patrick')}>
              <PlayerImage src={patrick} alt="patrick" />
              {showBackground.patrick && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
            ...
            <div className={containerClasses} onClick={() => handleClick('edenilson')}>
              <PlayerImage src={edenilson} alt="edenilson" />
              {showBackground.edenilson && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
                      <p className='mr-4'>Jogados: 11</p>
            ...
            <div className={containerClasses} onClick={() => handleClick('igorgomes')}>
              <PlayerImage src={igorgomes} alt="igorgomes" />
              {showBackground.igorgomes && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
                      <p className='mr-4'>Jogados: 7</p>
            ...
            <div className={containerClasses} onClick={() => handleClick('rubens')}>
              <PlayerImage src={rubens} alt="rubens" />
              {showBackground.rubens && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
                      <p className='mr-4'>Jogados: 10</p>
            ...
            <div className={containerClasses} onClick={() => handleClick('hyoran')}>
              <PlayerImage src={hyoran} alt="hyoran" />
              {showBackground.hyoran && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
                      <p className='mr-4'>Jogados: 11</p>
            ...
            <div className={containerClasses} onClick={() => handleClick('paulinho')}>
              <PlayerImage src={paulinho} alt="paulinho" />
              {showBackground.paulinho && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
                      <p className='mr-4'>Jogados: 11</p>
            ...
            <div className={containerClasses} onClick={() => handleClick('pavon')}>
              <PlayerImage src={pavon} alt="pavon" />
              {showBackground.pavon && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
                      <p className='mr-4'>Jogados: 11</p>
            ...
            <div className={containerClasses} onClick={() => handleClick('vargas')}>
              <PlayerImage src={vargas} alt="vargas" />
              {showBackground.vargas && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
                      <p className='mr-4'>Jogados: 8</p>
            ...
            <div className={containerClasses} onClick={() => handleClick('kardec')}>
              <PlayerImage src={kardec} alt="kardec" />
              {showBackground.kardec && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
                      <p className='mr-4'>Jogados: 1</p>
            ...
            <div className={containerClasses} onClick={() => handleClick('zaracho')}>
              <PlayerImage src={zaracho} alt="zaracho" />
              {showBackground.zaracho && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
                      <p className='mr-4'>Jogados: 11</p>
            ...
            <div className={containerClasses} onClick={() => handleClick('pedrinho')}>
              <PlayerImage src={pedrinho} alt="pedrinho" />
              {showBackground.pedrinho && (
                <>
                  <div className="absolute flex flex-col justify-center items-center text-white">
                    <div className='flex'>
                      <p className='mr-4'>Jogados: 1</p>
